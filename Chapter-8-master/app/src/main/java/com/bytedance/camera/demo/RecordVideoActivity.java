    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_picture).setOnClickListener(v -> {
            if (ContextCompat.checkSelfPermission(RecordVideoActivity.this,
                ...
                //todo 打开相机拍摄
                Intent intentTakeCamera = new Intent(MediaStore.ACTION_VIDEO_CAPTURE);
                if (intentTakeCamera.resolveActivity(getPackageManager()) != null) {
                    startActivityForResult(intentTakeCamera, REQUEST_VIDEO_CAPTURE);
                }
            }
        });
